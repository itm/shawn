 ...
 ************************************************************************/
#ifndef __SHAWN_TUBSAPPS_VIS_CREATE_DYNAMIC_EDGES_BYTAGS_H
#define __SHAWN_TUBSAPPS_VIS_CREATE_DYNAMIC_EDGES_BYTAGS_H
...
namespace vis
{
	 ...
	 * @sa DrawableEdge
	 */
   class CreateDynamicEdgesByTagsTask
   ...
   public:
      ...
      virtual ~CreateDynamicEdgesByTagsTask();
      ///@}
