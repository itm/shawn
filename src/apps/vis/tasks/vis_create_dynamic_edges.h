 ...
 ************************************************************************/
#ifndef __SHAWN_TUBSAPPS_VIS_CREATE_DYNAMIC_EDGES_H
#define __SHAWN_TUBSAPPS_VIS_CREATE_DYNAMIC_EDGES_H
...
namespace vis
{
   ...
   public:
      ...
      virtual ~CreateDynamicEdgesTask();
      ///@}
