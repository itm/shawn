 ...
 ************************************************************************/
#ifndef __VIS_DRAWABLE_NODE_GRAPHICS_FACTORY_H
#define __VIS_DRAWABLE_NODE_GRAPHICS_FACTORY_H
...
namespace vis
{
   DECLARE_HANDLES(DrawableNodeGraphicsFactory);

   /** \brief A factory for creating DrawableNodeGraphics instances.
    * This WriterFactory creates instances of DrawableNodeGraphics.
    */
   class DrawableNodeGraphicsFactory
   ...
   public:
      ...
      virtual ~DrawableNodeGraphicsFactory();
      ///@}
