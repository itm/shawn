 ...
 ************************************************************************/
#ifndef __SHAWN_TUBSAPPS_VIS_DRAWABLE_EDGE_DYNAMIC_TX_RANGE_H
#define __SHAWN_TUBSAPPS_VIS_DRAWABLE_EDGE_DYNAMIC_TX_RANGE_H
...
namespace vis
{
	 ...
	 * @sa CreateEdgesTask
	 */
   class DrawableEdgeDynamicTransmissionRange
      : public DrawableEdge
   {
   public:
      ///@name Contructor/Destructor
      ///@{
      DrawableEdgeDynamicTransmissionRange( const shawn::Node&,
                           const shawn::Node&,
                           const std::string& p = PREFIX,
                           const std::string& np = DrawableNodeDefault::PREFIX,
                           const std::string source_regex = ".*",
                           const std::string target_regex = ".*");
      virtual ~DrawableEdgeDynamicTransmissionRange();
      ///@}
