...
#include "apps/vis/elements/vis_drawable_edge_dynamic_transmission_range.h"
...
namespace vis
{
   ...
   const std::string DrawableEdgeDynamicTransmissionRange::PREFIX("dynamic_tx");
   // ----------------------------------------------------------------------
   DrawableEdgeDynamicTransmissionRange::
   DrawableEdgeDynamicTransmissionRange( const shawn::Node& v1,
                        const shawn::Node& v2,
                        const std::string& p,
                        const std::string& np,
