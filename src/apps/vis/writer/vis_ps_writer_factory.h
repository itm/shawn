 ...
 ************************************************************************/
#ifndef __VIS_PS_WRITER_FACTORY_H
#define __VIS_PS_WRITER_FACTORY_H
...
namespace vis
{
   DECLARE_HANDLES(PsWriterFactory);

   /** \brief A factory for creating PsWriter instances.
    * This WriterFactory creates instances of PsWriter, which are used to
    * output the visualization to a Postscript document.
    */
   class PsWriterFactory
