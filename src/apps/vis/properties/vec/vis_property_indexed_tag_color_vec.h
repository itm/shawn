 ...
 ************************************************************************/
#ifndef __VIS_PROPERTIES_INDEXED_TAG_COLOR_VEC_H
#define __VIS_PROPERTIES_INDEXED_TAG_COLOR_VEC_H
...
namespace vis
{
    ...
    */
   class PropertyIndexedTagColorVecTask
      : public PropertyTask
   {
   public:
       ...
       */
      class PropertyIndexedTagColorVec
         : public Property<shawn::Vec>
      {
      public:
         ///@name Constructor/Destructor
         ///@{
         PropertyIndexedTagColorVec( const shawn::Node*, std::string tag );
         virtual ~PropertyIndexedTagColorVec();
         ///@}
         /**
      ...
      virtual ~PropertyIndexedTagColorVecTask();
      ///@}
