 ...
 ************************************************************************/
#ifndef __SHAWN_APPS_WISEML_SCENARIO_TASK_H
#define __SHAWN_APPS_WISEML_SCENARIO_TASK_H
...
namespace wiseml
{
   /** \brief Creates a Scenario
    */
   class WisemlScenarioTask
      : public SimulationTask
   {
   public:
      /// Constructor/Destructor
      WisemlScenarioTask();
      virtual ~WisemlScenarioTask();
