 ...
 ************************************************************************/
#ifndef __SHAWN_APPS_WISEML_NODEDEFAULTS_TASK_H
#define __SHAWN_APPS_WISEML_NODEDEFAULTS_TASK_H
...
namespace wiseml
{
    ...
    * topology.
    */
   class WisemlNodeDefaultsTask
      : public SimulationTask
   {
   public:
      /// Constructor/Destructor
      WisemlNodeDefaultsTask();
      virtual ~WisemlNodeDefaultsTask();
