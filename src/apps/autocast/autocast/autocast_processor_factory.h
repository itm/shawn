...
#ifndef __SHAWN_LEGACYAPPS_AUTOCAST_PROCESSOR_FACTORY_H
#define __SHAWN_LEGACYAPPS_AUTOCAST_PROCESSOR_FACTORY_H
...
namespace autocast
{
   ...
   class AutoCastProcessorFactory
      : public shawn::ProcessorFactory
   {
   public:
      AutoCastProcessorFactory();
      virtual ~AutoCastProcessorFactory();
