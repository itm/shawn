 ...
 ************************************************************************/
#ifndef __SHAWN_APPS_ROUTING_GEO_GEO_ROUTING_FACTORY_H
#define __SHAWN_APPS_ROUTING_GEO_GEO_ROUTING_FACTORY_H
...
namespace routing
{
	namespace geo
	{
		class GeoRoutingProcessorFactory : public shawn::ProcessorFactory
		{
		public:
		...
		class GeoRoutingFactory : public routing::RoutingFactory
		{
		public:
			virtual ~GeoRoutingFactory();
