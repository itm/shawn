 ...
 ************************************************************************/
#ifndef __SHAWN_APPS_ROUTING_TREE_TREE_ROUTING_FACTORY_H
#define __SHAWN_APPS_ROUTING_TREE_TREE_ROUTING_FACTORY_H
...
namespace routing
{
	namespace tree
	{
		class TreeRoutingProcessorFactory : public shawn::ProcessorFactory
		{
		public:
			TreeRoutingProcessorFactory();
			virtual ~TreeRoutingProcessorFactory();
		...
		class TreeRoutingFactory : public routing::RoutingFactory
		{
		public:
			virtual ~TreeRoutingFactory();
