 ...
 ************************************************************************/
#ifndef __SHAWN_APPS_WISELIB_METRICS_INDIVIDUAL_LINK_PROCESSOR_FACTORY_H
#define __SHAWN_APPS_WISELIB_METRICS_INDIVIDUAL_LINK_PROCESSOR_FACTORY_H
...
namespace wiselib
{
   ...
   class IndividualLinkMetricsProcessorFactory
      : public shawn::ProcessorFactory
   {
      public:
         IndividualLinkMetricsProcessorFactory();
         virtual ~IndividualLinkMetricsProcessorFactory();
