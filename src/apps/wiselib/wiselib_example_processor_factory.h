 ...
 ************************************************************************/
#ifndef __SHAWN_APPS_WISELIB_EXAMPLE_PROCESSOR_FACTORY_H
#define __SHAWN_APPS_WISELIB_EXAMPLE_PROCESSOR_FACTORY_H
...
namespace wiselib
{
   ...
   class WiselibExampleProcessorFactory
      : public shawn::ProcessorFactory
   {
      public:
         WiselibExampleProcessorFactory();
         virtual ~WiselibExampleProcessorFactory();
