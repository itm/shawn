...
#ifndef __SHAWN_SYS_DISTANCE_ESTIMATES_TASK_LQI_DISTANCE_ESTIMATE_H
#define __SHAWN_SYS_DISTANCE_ESTIMATES_TASK_LQI_DISTANCE_ESTIMATE_H
...
namespace shawn
{
   ...
   class SimulationTaskLQIDistanceEstimate
      : public SimulationTask
   {
   public:
      SimulationTaskLQIDistanceEstimate();
      virtual ~SimulationTaskLQIDistanceEstimate();
