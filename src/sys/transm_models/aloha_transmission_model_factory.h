...
#ifndef __SHAWN_SYS_TRANSM_MODELS_ALOHA_TRANSMISSION_MODEL_FACTORY_H
#define __SHAWN_SYS_TRANSM_MODELS_ALOHA_TRANSMISSION_MODEL_FACTORY_H
...
namespace shawn
{
    ...
    public:
        ...
        virtual ~AlohaTransmissionModelFactory();
