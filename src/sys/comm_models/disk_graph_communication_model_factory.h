...
#ifndef __SHAWN_SYS_TRANS_MODELS_DISK_GRAPH_MODEL_FACTORY_H
#define __SHAWN_SYS_TRANS_MODELS_DISK_GRAPH_MODEL_FACTORY_H
...
namespace shawn
{
   ...
   class SimulationController;
	...
	{
	public:
		virtual ~DiskGraphCommunicationModelFactory();
